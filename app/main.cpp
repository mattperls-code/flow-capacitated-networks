...
int main()
{
    ...
    FlowCapacitatedNetwork network4 = FlowCapacitatedNetwork::fromMultiBoundaryEdgeCapacitated(
        { "S", "A", "B", "C", "D", "T" },
        {"S"},
        {"T"},
        {
    ...
    FlowCapacitatedNetwork network5 = FlowCapacitatedNetwork::fromMultiBoundaryVertexCapacitated(
        { "S", "A", "B", "C", "D", "T" },
        {"S"},
        {"T"},
        {
    ...
    FlowCapacitatedNetwork network6 = FlowCapacitatedNetwork::fromMultiBoundaryEdgeAndVertexCapacitated(
        { "S", "A", "B", "C", "D", "T" },
        {"S"},
        {"T"},
        {
